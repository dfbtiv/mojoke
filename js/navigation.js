// Menu Functions
function restaurant_food_delivery_openNav() {
  jQuery(".sidenav").addClass('show');
}

function restaurant_food_delivery_closeNav() {
  jQuery(".sidenav").removeClass('show');
}

/////////////////////// Focus handling ///////////////////////
(function(window, document) {
  function restaurant_food_delivery_handleMobileMenuNavigation() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    restaurant_food_delivery_handleMobileMenuNavigation();
