...
if (!function_exists('restaurant_food_delivery_enqueue_scripts')) {
	...
	function restaurant_food_delivery_enqueue_scripts() {
		...
		if ( get_theme_mod( 'restaurant_food_delivery_animation_enabled', true ) ) {
			wp_enqueue_script(
				'restaurant-food-delivery-wow-script',
			...
			wp_enqueue_style(
				'restaurant-food-delivery-animate',
...
if (!function_exists('restaurant_food_delivery_after_setup_theme')) {
	...
	function restaurant_food_delivery_after_setup_theme() {
		...
		load_theme_textdomain( 'restaurant-food-delivery', get_stylesheet_directory() . '/languages' );
...
require get_template_directory() .'/core/includes/customizer-notice/restaurant-food-delivery-customizer-notify.php';
...
if (!function_exists('restaurant_food_delivery_widgets_init')) {
	...
	function restaurant_food_delivery_widgets_init() {
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Sidebar 2','restaurant-food-delivery'),
			'id'   => 'restaurant-food-delivery-sidebar-2',
			'description'   => esc_html__('This sidebar will be shown next to the content.', 'restaurant-food-delivery'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
		...
		register_sidebar(array(
			...
			'name' => esc_html__('Sidebar 3','restaurant-food-delivery'),
			'id'   => 'restaurant-food-delivery-sidebar-3',
			'description'   => esc_html__('This sidebar will be shown next to the content.', 'restaurant-food-delivery'),
			'before_widget' => '<div id="%1$s" class="sidebar-widget %2$s">',
			'after_widget'  => '</div>',
			'before_title'  => '<h4 class="title">',
            ...
            edit_post_link(
                sprintf(
                    ...
                    /* translators: %s: Name of current post. Only visible to screen readers */
                        __('Edit <span class="screen-reader-text">%s</span>', 'restaurant-food-delivery'),
                        array(
                            'span' => array(
                                'class' => array(),
                            ),
