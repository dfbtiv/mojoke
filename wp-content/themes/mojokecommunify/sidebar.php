<div class="sidebar-area mt-5 wow fadeInRight">
    <?php if ( ! dynamic_sidebar( 'mojoke-sidebar' ) ) : ?>
      <h4 class="title"><?php esc_html_e('Search Here', 'mojoke'); ?></h4>
        <form method="get" id="searchform" class="searchform" action="<?php echo esc_url(home_url('/')); ?>">
            <input placeholder="<?php esc_attr_e('Type here...', 'mojoke'); ?>" type="text" name="s" id="search" value="<?php the_search_query(); ?>" />
            <input type="submit" class="search-submit" value="<?php esc_attr_e('Search', 'mojoke');?>" />
        </form>
