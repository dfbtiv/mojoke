var Whizzie = (function($) {
  ...
  function PluginManager() {
        ...
        if (typeof response.url != 'undefined') {
          ...
          if (response.hash == current_item_hash) {
            ...
            jQuery.post(response.url, response, function(response2) {
              process_current();
              $current_node.find('span').text(response.message + restaurant_food_delivery_whizzie_params.verify_text);
            }).fail(ajax_callback);
          }
    ...
    function process_current() {
      if (current_item) {
        ...
        jQuery.post(restaurant_food_delivery_whizzie_params.ajaxurl, {
          action: 'setup_plugins',
          wpnonce: restaurant_food_delivery_whizzie_params.wpnonce,
          slug: current_item
  ...
  function WidgetManager() {
    function import_widgets() {
      jQuery.post(
        restaurant_food_delivery_whizzie_params.ajaxurl, {
